"""
LZ78 Compression with LRU Prune Strategy
...
==================================================================
Because encoder and decoder share DLL logic, we create a common base class 
"""
...
class DictionaryBase:
    """
    Base class for LZ78 Encoder and Decoder Dictionaries with LRU Pruning
    Implements DLL and Auxiliary Arrays for pruning
    """

    def __init__(self, max_size=4096):
        self.max_size = max_size
        self.next_index = 1 # used while growing
        self.free_index = None # used once full
        self.full = False
...
class LZ78EncoderDictionary(DictionaryBase):
    ...
    def prune(self):
        ...
        # Update Parent: decrement child count, if childless (and not root) add as leaf
        self.child_count[parent_index] -= 1
        if self.child_count[parent_index] == 0 and parent_index != 0:
...
class LZ78DecoderDictionary(DictionaryBase):
    """
...
class LZ78PruneEncoder(DataEncoder):
    def __init__(self, max_size=4096):
        self.max_size = max_size
...
class LZ78PruneDecoder(DataDecoder):
    def __init__(self, max_size=4096):
        self.max_size = max_size
