    ...
    def encode(self, data: bytearray):
        ...
        for char in data[1:]:
            ...
            if child_index is None: 
                # End of phrase: add index to stream, add tuple to dictionary, start new phrase at char
...
class LZWFreezeEncoder(DataEncoder):
    def __init__(self, max_size=4096):
        self.max_size = max_size
...
class LZWFreezeDecoder(DataDecoder):
    def __init__(self, max_size=4096):
        self.max_size = max_size
